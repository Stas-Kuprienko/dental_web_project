...
<section style="font-size:22px;">
  ...
  <div class="work">
    ...
    <form method="post" action="/dental/main/dental-work/${work.id}">
  ...
  <form id="status-form" method="post" action="/dental/main/dental-work/${work.id}" style="display:none">
    <select name="value">
  ...
  <div class="work">
    ...
    <form id="comment-form" method="post" action="/dental/main/dental-work/${work.id}" style="display:none">
      <textarea name="value">
        ${work.comment}
      </textarea>
