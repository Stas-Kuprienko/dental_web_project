...
<form action="/dental/edit-work">
    ...
    <button type="submit" name="index" value="2">input</button>
    </p>
</form>
<form action="/dental/edit-work">
    <p class="center">
...
<form action="/dental/edit-work">
    ...
    <input type="hidden" name="field" value="delete-product">
</form>
<form action="/dental/edit-work">
    <a class="center_list">
        ...
        <input type="hidden" name="field" value="add-product">
...
<button type="submit" action=" " style="float: left; font-size: 20px; min-height: 110px; width: 100px;">OPEN PHOTO</button>
<form  action="/dental/welcome">
    <button type="submit" action=" " style="float: left; font-size: 20px; min-height: 110px; width: 100px;">BACK</button>
</form>
</section>
</body>
</html>
